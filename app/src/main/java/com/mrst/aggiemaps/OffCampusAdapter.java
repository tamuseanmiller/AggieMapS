...
public class OffCampusAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (tag) {
            case ON_CAMPUS:
                return new OffCampusAdapter.OnCampusViewHolder(mInflater.inflate(R.layout.recyclerview_route, parent, false));
            case OFF_CAMPUS:
                return new OffCampusAdapter.OffCampusViewHolder(mInflater.inflate(R.layout.recyclerview_route, parent, false));
            case GAME_DAY:
                return new OffCampusAdapter.GameDayViewHolder(mInflater.inflate(R.layout.recyclerview_route, parent, false));
            default:
                return new OffCampusAdapter.FavoritesViewHolder(mInflater.inflate(R.layout.recyclerview_route, parent, false));
        }
    }
